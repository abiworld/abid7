...
class imageLib
{
    ...
    public $width;					# Current width (width after resize)
    public $height;
    private $imageSize;
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/		
	...
	public function addText($text, $pos = '20x20', $padding = 0, $fontColor='#fff', $fontSize = 12, $angle = 0, $font = null,$area=0,$alpha)
    # Author:     Jarrod Oberto
	# Date:       18-11-09
    ...
    #
	{
		...
		$fontColor = imagecolorallocatealpha($this->imageResized, $r, $g, $b,127 * ( 100 - $alpha ) / 100);
